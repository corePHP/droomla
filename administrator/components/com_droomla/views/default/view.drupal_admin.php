...
class DroomlaViewDefault extends JView {
	function display( $tpl = false ) {
		...
		//<a href="http://localhost:8888/droomla/v3/components/com_droomla/drupal/">Home</a>
		$this->assign( 'query', str_replace( 'administrator/', '', Drupal::$_droomla_uri ) );
		$this->assign( 'path', str_replace( 'administrator/', '', JURI::base() ) . 'components/com_droomla/drupal/' );
