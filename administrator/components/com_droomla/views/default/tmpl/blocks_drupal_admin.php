            ...
            <div id="squeeze">
                <div class="right-corner">
                    <div class="left-corner">
                        ...
                        <a href="<?php echo JURI::base() ?>">Joomla! Administration</a> › 
						<a href="<?php echo JURI::base() ?>?option=com_droomla">Home</a> › 
            			<a href="<?php echo $this->query ?>&q=admin">Administer</a> › <a href="<?php echo $this->query ?>&q=admin/build" title="Control how your site looks and feels.">Site building</a></div>
